...
const redirectsMiddleware =
    require('@dvcorg/websites-server/src/middleware/redirects')
...
const plugins = [
  ...
  {
    resolve : 'gatsby-source-filesystem',
    options : {name : 'images', path : path.join(__dirname, 'static', 'img')}
  },
  {
    resolve : '@dvcorg/gatsby-theme-iterative',
    options : {simpleLinkerTerms : require('./content/linked-terms')}
  },
  {
  ...
  'gatsby-plugin-meta-redirect', '@sentry/gatsby'
]
